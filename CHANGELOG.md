...
- perf(embedder): pipeline native image preprocessing and embedding per chunk so preprocessing and GPU embedding can overlap, with cancellation-safe cleanup and focused concurrency regression tests.
